...
cache_dir = ''
AG_news_pretrained_weights = path / 'Ag_News_Bert/pytorch_model.bin'
num_labels = 4
#label_list = ['World', 'Sports', 'Business', 'Sci/Tech']
label_list = [0, 1, 2, 3]

def get_train_examples(train_df): #Modif for AG_News dataset from Dataframe
    examples=[]
...
model_state_dict = torch.load(AG_news_pretrained_weights)
